...
import logoexpo from "../../images/Frame-122.png";
...
const Expositor = () => {
  ...
  const register = (event) => {
    ...
    axios
      .post("https://nossostand.willhack.app/users/auth/register", user)
      .then((res) => {
    ...
    <div id="expositor">
      ...
      <div className="main-expo">
        <div className="expo-1">
          ...
          <h2>
            Hey <span style={{ color: "#FF8401" }}>Expositor</span>, Preparamos
