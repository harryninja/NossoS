    ...
    <div className="sidebar">
      ...
      <div className="center">
        <ul>
          ...
          <li>
           <HomeIcon className="icone"/> <span>ADM expositor</span>
          </li>
          ...
          <Link className="Link" to="/dashboard" style={{ textDecoration: "none" }}>
            <li>
              ...
              <span>Solicitação na plataforma</span>
            </li>
          </Link>
          ...
          <li>
            ...
            <span>Ver empresas da montadora</span>
          </li>
          <li>
          ...
          <li>
            <TextsmsOutlinedIcon className="icone" />
            <span>Conversas</span>
          </li>

          <p></p>
          <li className="botao">
<button className="botaoLaranja">CHAT</button>
          </li>
